...
typedef struct mdmptools_option mdmptools_option_t;

struct mdmptools_option
{
...
void mdmptools_getopt_wrapped_fprint(
      FILE *stream,
...
void mdmptools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const mdmptools_option_t *options,
      int number_of_options );

int mdmptools_getopt_get_options_string(
     const mdmptools_option_t *options,
     int number_of_options,
